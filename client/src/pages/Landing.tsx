...
export default function Landing() {
    const {doctors, contactInfo, blogPosts} = useApp();
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <section id="blog" className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Section Header */}
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-semibold mb-4">Latest Blog Posts</h2>
                        <p className="text-lg text-muted-foreground">
                            Read our latest articles and medical insights
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {blogPosts.map((post) => (
                            <Card
                                key={post.id}
                                className="overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 hover:-translate-y-1"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-muted rounded-lg overflow-hidden">
                            <div
                                className="w-full h-full min-h-[300px] flex items-center justify-center text-muted-foreground">
